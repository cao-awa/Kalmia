...
```json
{
  ...
  "stacktrace": [
    ...
    " - at com.github.kusa233.kalmia.server.network.http.handler.KalmiaHttpRequestHandler.handle(KalmiaHttpRequestHandler.kt:42)",
    " - at com.github.kusa233.kalmia.server.network.http.pipeline.KalmiaHttpRequestPipeline$handleFull$1.invokeSuspend$lambda$0(KalmiaHttpRequestPipeline.kt:107)",
    " - at com.github.kusa233.kalmia.server.network.pipeline.KalmiaRequestPipeline.abortable(KalmiaRequestPipeline.kt:22)",
    " - at com.github.kusa233.kalmia.server.network.http.pipeline.KalmiaHttpRequestPipeline$handleFull$1.invokeSuspend(KalmiaHttpRequestPipeline.kt:102)",
