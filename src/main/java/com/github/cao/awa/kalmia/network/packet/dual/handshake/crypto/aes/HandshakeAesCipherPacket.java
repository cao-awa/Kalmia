package com.github.cao.awa.kalmia.network.packet.dual.handshake.crypto.aes;
...
import com.github.cao.awa.kalmia.network.packet.dual.handshake.hello.server.ServerHelloPacket;
...
@Generic
@AutoSolvedPacket(2)
public class HandshakeAesCipherPacket extends DualPacket<HandshakeHandler> {
