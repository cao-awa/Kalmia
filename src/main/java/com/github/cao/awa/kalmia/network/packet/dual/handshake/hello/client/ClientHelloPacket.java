package com.github.cao.awa.kalmia.network.packet.dual.handshake.hello.client;
...
import com.github.cao.awa.kalmia.network.packet.dual.handshake.crypto.ec.pubkey.HandshakePreSharedEcPacket;
...
@Generic
@AutoSolvedPacket(0)
public class ClientHelloPacket extends DualPacket<HandshakeHandler> {
