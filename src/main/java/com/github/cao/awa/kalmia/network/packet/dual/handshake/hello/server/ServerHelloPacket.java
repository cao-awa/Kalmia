package com.github.cao.awa.kalmia.network.packet.dual.handshake.hello.server;
...
import com.github.cao.awa.kalmia.network.packet.dual.login.password.LoginWithPasswordPacket;
...
@Generic
@AutoSolvedPacket(3)
public class ServerHelloPacket extends DualPacket<HandshakeHandler> {
