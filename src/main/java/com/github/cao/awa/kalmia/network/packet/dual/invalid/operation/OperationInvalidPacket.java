package com.github.cao.awa.kalmia.network.packet.dual.invalid.operation;
 ...
 */
public class OperationInvalidPacket<T extends PacketHandler<T>> extends DualPacket<T> {
